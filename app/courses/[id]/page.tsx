  ...
  useEffect(() => {
    async function fetchCourse() {
      try {
        ...
        setValue("imgSrc", course.imgSrc);
        setValue("createdBy", course.createdBy);
        setValue("displayOrder", course.display_order);
        if (course.imgSrc) {
          setImagePreview(course.imgSrc);
        }
      } catch (error) {
      ...
      <div className="mt-16 mb-20">
        <div className="flex">
          ...
          <div className="w-3/4 mx-auto">
            <h1 className="text-2xl font-bold mb-4">Cập Nhật Khóa Học</h1>
            <form
